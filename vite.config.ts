...
export default defineConfig(({ mode }) => ({
    ...
    mode === "production" &&
      VitePWA({
        ...
        manifest: {
          ...
          description:
            "Читай і слухай ведичні тексти українською. Бгаґавад-Ґіта, Шрімад-Бгаґаватам тощо з коментарями Шріли Прабгупади.",
          theme_color: "#d97706",
  ...
  build: {
    rollupOptions: {
      output: {
        manualChunks: {
          // Vendor chunks - розділяємо великі бібліотеки
    ...
    chunkSizeWarningLimit: 500, // Знижуємо поріг для кращого моніторингу
  },
}));
