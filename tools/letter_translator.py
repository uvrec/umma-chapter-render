...
def main():
    ...
    translated_data = translator.translate_letter_data(
        letter_data,
    ...
    print(f"[INFO] Перекладено {len(translated_data.get('content', []))} текстів")
