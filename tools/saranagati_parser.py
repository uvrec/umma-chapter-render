...
ПРАВИЛА АТРИБУЦІЇ ПОЯСНЕНЬ (BBT Editorial Guidelines):
======================================================
Для книг "Шаранаґаті", "Падма-пурана" та інших текстів, де коментарів немає
...
Зібраний матеріал додавати до поля `purport_ua` / `purport_en` з атрибуцією:
    ...
    Під час ранкової прогулянки (дата, місце) Його Божественна Милість
    А.Ч. Бгактіведанта Свамі Прабгупада каже: «...».
