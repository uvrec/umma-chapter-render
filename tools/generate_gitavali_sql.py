#!/usr/bin/env python3
"""
Generate SQL migration for Gitavali book with proper verses table structure.
...
def clean_artifacts(text: str) -> str:
    ...
    # Remove UPDATED/UDPATED (typo) line
...
def generate_migration():
    # Load parsed data
    data_path = Path(__file__).parent.parent / "src" / "data" / "gitavali-parsed.json"
    ...
    # Header
    sql_parts.append("""-- Import Gitavali by Bhaktivinoda Thakura
...
""")
            ...
            for i in range(num_verses):
                ...
                # commentary_en - English purport on last verse
                verse_comm_en = escape_sql(purport_en) if verse_num == num_verses else ''

                # commentary_ua - no Ukrainian purports yet
                verse_comm_ua = ''
...
def main():
    output_path = Path(__file__).parent.parent / "supabase" / "migrations" / "20260112120000_import_gitavali.sql"
