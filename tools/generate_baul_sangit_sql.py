#!/usr/bin/env python3
"""
Generate SQL migration for Baul Sangit book with proper verses table structure.
12 songs by Bhaktivinoda Thakura (1893)
"""
...
def generate_migration():
    data_path = Path(__file__).parent.parent / "src" / "data" / "baul-sangit-parsed.json"
    with open(data_path, 'r', encoding='utf-8') as f:
        data = json.load(f)

    sql_parts = []
    sql_parts.append("""-- Import Baul Sangit by Bhaktivinoda Thakura (1893)
...
def main():
    output_path = Path(__file__).parent.parent / "supabase" / "migrations" / "20260112140000_import_baul_sangit.sql"
