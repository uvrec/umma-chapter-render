-- ============================================
-- TD Volume 1, Chapter 1 - Re-import Verses
-- Run this to restore Chapter 1 verses after chapter_type change
-- ============================================
...
BEGIN
  ...
  IF v_chapter_id IS NULL THEN
    RAISE EXCEPTION 'Chapter 1 not found for TD Volume 1';
  END IF;

  -- Delete existing verses for this chapter (clean slate)
  DELETE FROM public.verses WHERE chapter_id = v_chapter_id;
...
<p>At the mention of the sun god, Nandajī expressed some doubt as to how this should be understood. It seemed to him somewhat symbolic. But ŚrīlaPrabhupāda explained that Vivasvān actually exists and that everything in the <em>Gītā</em> is factual, not symbolic.</p>
