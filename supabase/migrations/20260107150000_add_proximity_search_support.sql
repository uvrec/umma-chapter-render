...
BEGIN
  ...
  SELECT
    ...
    -- Релевантність
    CASE
      WHEN language_code = 'ua' AND v.search_vector_ua IS NOT NULL AND ts_query IS NOT NULL AND ts_query != ''::tsquery THEN
...
BEGIN
  ...
  (SELECT
    ...
    CASE
      WHEN language_code = 'ua' AND bp.search_vector_ua IS NOT NULL AND ts_query IS NOT NULL AND ts_query != ''::tsquery THEN
