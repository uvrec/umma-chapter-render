...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE table_name = 'ekadashi_info' AND column_name = 'prabhupada_instructions_uk'
  ) THEN
    ALTER TABLE ekadashi_info
      ADD COLUMN prabhupada_instructions_uk TEXT,
