-- Add RPC functions for looking up canto/chapter by number with preview token support
-- These functions support preview tokens for viewing unpublished content
-- Note: get_book_with_preview already exists in 20260131150000_add_get_book_with_preview.sql
