...
INSERT INTO public.cantos (book_id, canto_number, title_en, title_ua, description_en, description_ua)
SELECT
  id as book_id,
  1 as canto_number,
  ...
  'Листопад 1975 – Квітень 1976' as description_ua
FROM public.books
WHERE slug = 'td'
ON CONFLICT (book_id, canto_number) DO NOTHING;

-- Insert Chapter 1: New Delhi and Kurukṣetra
INSERT INTO public.chapters (canto_id, chapter_number, title_en, title_ua, chapter_type, content_en, content_ua)
SELECT
  c.id as canto_id,
  1 as chapter_number,
  'New Delhi and Kurukṣetra' as title_en,
  'Нью-Делі та Курукшетра' as title_ua,
...
SELECT
  ...
  'Шрі Вріндавана-дхама' as title_ua,
  'text'::chapter_type as chapter_type,
