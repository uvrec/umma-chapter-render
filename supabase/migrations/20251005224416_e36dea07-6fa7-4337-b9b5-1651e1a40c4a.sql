...
SET 
  ...
  meta_description_uk = 'Підтримайте проєкт з перекладу та поширення ведичних знань українською мовою. Ваш внесок допомагає розвитку духовної освіти.',
