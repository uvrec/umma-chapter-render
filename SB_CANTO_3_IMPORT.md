...
## Альтернатива: TypeScript імпортер (в розробці)

Інструмент доступний в admin панелі:
- URL: `/admin/sb-canto-import`
- Статус: 🚧 В розробці (потребує доопрацювання EPubJS інтеграції)

**Поточні обмеження:**
- Не підтримує витягування XHTML з EPUB
- Рекомендовано використовувати Python скрипт
...
- TypeScript парсер: `src/utils/import/srimad_bhagavatam_epub_parser.ts`
- TypeScript merger: `src/utils/import/srimad_bhagavatam_merger.ts`
- TypeScript імпортер: `src/pages/admin/SBCantoImport.tsx`
