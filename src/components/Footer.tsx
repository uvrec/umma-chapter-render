export const Footer = () => {
  const socialLinks = [
    ...
    {
      name: "Instagram",
      url: "https://instagram.com/vedicportal",
      icon: (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "YouTube",
      url: "https://youtube.com/@vedicportal",
      icon: (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <footer className="bg-card border-t border-border mt-auto" aria-label="Footer">
