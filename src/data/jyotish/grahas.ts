...
export const GRAHAS: Graha[] = [
  {
    ...
    name_en: 'Surya',
    name_sanskrit: 'सूर्य',
    western_name_ua: 'Сонце',
    western_name_en: 'Sun',
    day_of_week_ua: 'Неділя',
    day_of_week_en: 'Sunday',
    nature: 'malefic',
    element: 'fire',
    color_ua: 'Оранжевий, золотий',
    ...
    description_ua: 'Сур\'я — цар планет, що символізує душу, его, батька та владу. Дарує життєву силу, самовпевненість та лідерські якості.',
  ...
  },
  {
    ...
    western_name_ua: 'Місяць',
    western_name_en: 'Moon',
    day_of_week_ua: 'Понеділок',
    day_of_week_en: 'Monday',
    nature: 'benefic',
    element: 'water',
    color_ua: 'Білий, сріблястий',
    color_en: 'White, silver',
    metal_ua: 'Срібло',
    metal_en: 'Silver',
    gemstone_ua: 'Перлина, місячний камінь',
    gemstone_en: 'Pearl, moonstone',
    direction: 'Northwest',
    owns_rashis: [4], // Карката
    exalted_in: 2, // Врішабга
    debilitated_in: 8, // Врішчіка
    description_ua: 'Чандра — королева планет, що символізує розум, емоції, матір та комфорт. Дарує емоційну стабільність, інтуїцію та турботливість.',
  ...
  },
  {
    ...
    name_en: 'Mangala',
    name_sanskrit: 'मंगल',
    western_name_ua: 'Марс',
    western_name_en: 'Mars',
    day_of_week_ua: 'Вівторок',
    day_of_week_en: 'Tuesday',
    nature: 'malefic',
    element: 'fire',
    color_ua: 'Червоний',
    color_en: 'Red',
    metal_ua: 'Мідь, залізо',
    metal_en: 'Copper, iron',
    gemstone_ua: 'Червоний корал',
    gemstone_en: 'Red coral',
    direction: 'South',
    owns_rashis: [1, 8], // Меша, Врішчіка
    exalted_in: 10, // Макара
    debilitated_in: 4, // Карката
    description_ua: 'Манґала — воїн серед планет, що символізує енергію, сміливість, брата та землю. Дарує рішучість, силу та захисні здібності.',
  ...
  },
  {
    ...
    name_en: 'Budha',
    name_sanskrit: 'बुध',
    western_name_ua: 'Меркурій',
    western_name_en: 'Mercury',
    day_of_week_ua: 'Середа',
    day_of_week_en: 'Wednesday',
    nature: 'neutral',
    element: 'earth',
    color_ua: 'Зелений',
    color_en: 'Green',
    metal_ua: 'Бронза, латунь',
    ...
    description_ua: 'Будга — принц планет, що символізує інтелект, комунікацію, торгівлю та навчання. Дарує аналітичний розум, красномовство та адаптивність.',
  ...
  },
  {
    ...
    name_en: 'Guru',
    name_sanskrit: 'गुरु',
    western_name_ua: 'Юпітер',
    western_name_en: 'Jupiter',
    day_of_week_ua: 'Четвер',
    day_of_week_en: 'Thursday',
    nature: 'benefic',
    element: 'ether',
    color_ua: 'Жовтий, золотий',
    color_en: 'Yellow, golden',
    metal_ua: 'Золото',
    metal_en: 'Gold',
    gemstone_ua: 'Жовтий сапфір, топаз',
    gemstone_en: 'Yellow sapphire, topaz',
    direction: 'Northeast',
    owns_rashis: [9, 12], // Дгануш, Міна
    exalted_in: 4, // Карката
    debilitated_in: 10, // Макара
    description_ua: 'Ґуру — вчитель богів, що символізує мудрість, духовність, дітей та багатство. Найбільш благодійна планета, що дарує процвітання та захист.',
  ...
  },
  {
    ...
    name_en: 'Shukra',
    name_sanskrit: 'शुक्र',
    western_name_ua: 'Венера',
    western_name_en: 'Venus',
    day_of_week_ua: 'П\'ятниця',
    day_of_week_en: 'Friday',
    nature: 'benefic',
    element: 'water',
    color_ua: 'Білий, рожевий',
    color_en: 'White, pink',
    metal_ua: 'Срібло, платина',
    metal_en: 'Silver, platinum',
    gemstone_ua: 'Діамант, білий сапфір',
    gemstone_en: 'Diamond, white sapphire',
    direction: 'Southeast',
    owns_rashis: [2, 7], // Врішабга, Тула
    exalted_in: 12, // Міна
    debilitated_in: 6, // Канья
    description_ua: 'Шукра — вчитель асурів, що символізує красу, любов, мистецтво та шлюб. Дарує чарівність, творчі здібності та матеріальні насолоди.',
  ...
  },
  {
    ...
    name_en: 'Shani',
    name_sanskrit: 'शनि',
    western_name_ua: 'Сатурн',
    western_name_en: 'Saturn',
    day_of_week_ua: 'Субота',
    day_of_week_en: 'Saturday',
    nature: 'malefic',
    element: 'air',
    color_ua: 'Чорний, темно-синій',
    color_en: 'Black, dark blue',
    metal_ua: 'Залізо, свинець',
    metal_en: 'Iron, lead',
    gemstone_ua: 'Синій сапфір',
    gemstone_en: 'Blue sapphire',
    direction: 'West',
    owns_rashis: [10, 11], // Макара, Кумбга
    exalted_in: 7, // Тула
    debilitated_in: 1, // Меша
    description_ua: 'Шані — суддя серед планет, що символізує карму, обмеження, дисципліну та довголіття. Дарує терпіння, витривалість та духовну зрілість через випробування.',
  ...
  },
  {
    ...
    name_en: 'Rahu',
    name_sanskrit: 'राहु',
    western_name_ua: 'Північний місячний вузол',
    western_name_en: 'North Lunar Node',
    day_of_week_ua: 'Субота (разом з Шані)',
    day_of_week_en: 'Saturday (with Shani)',
    nature: 'malefic',
    element: 'air',
    color_ua: 'Димчастий, ультрафіолетовий',
    color_en: 'Smoky, ultraviolet',
    metal_ua: 'Свинець',
    metal_en: 'Lead',
    gemstone_ua: 'Гессоніт (гомед)',
    gemstone_en: 'Hessonite (gomed)',
    direction: 'Southwest',
    owns_rashis: [], // Не володіє жодним
    exalted_in: 3, // Мітхуна
    debilitated_in: 9, // Дгануш
    description_ua: 'Раху — тіньова планета, що символізує ілюзію, матеріальні бажання та кармічні уроки. Дарує амбіції, інновації та здатність долати межі.',
  ...
  },
  {
    ...
    name_en: 'Ketu',
    name_sanskrit: 'केतु',
    western_name_ua: 'Південний місячний вузол',
    western_name_en: 'South Lunar Node',
    day_of_week_ua: 'Вівторок (разом з Манґалою)',
    day_of_week_en: 'Tuesday (with Mangala)',
    nature: 'malefic',
    element: 'fire',
    color_ua: 'Сірий, інфрачервоний',
    color_en: 'Gray, infrared',
    metal_ua: 'Залізо',
    metal_en: 'Iron',
    gemstone_ua: 'Котяче око',
    gemstone_en: 'Cat\'s eye',
    direction: 'Southwest',
    owns_rashis: [], // Не володіє жодним
    exalted_in: 9, // Дгануш
    debilitated_in: 3, // Мітхуна
    description_ua: 'Кету — тіньова планета, що символізує мокшу, духовне відречення та минулі життя. Дарує інтуїцію, духовні здібності та звільнення від прив\'язаностей.',
