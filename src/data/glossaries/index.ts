...
export { ISO_GLOSSARY_UK, ISO_GLOSSARY_EN, type GlossaryTermData } from "./iso-glossary";
export { RAJA_VIDYA_GLOSSARY_UK, RAJA_VIDYA_BOOK_INFO } from "./raja-vidya-glossary";
export { GITA_GLOSSARY_EN, GITA_GLOSSARY_INFO } from "./gita-glossary";

import { ISO_GLOSSARY_UK, ISO_GLOSSARY_EN } from "./iso-glossary";
import { RAJA_VIDYA_GLOSSARY_UK } from "./raja-vidya-glossary";
...
export const getGlossaryForBook = (bookSlug: string, language: string = "ua"): GlossaryTermData[] => {
  switch (bookSlug) {
    ...
    case "sri-isopanishad":
      return language === "uk" ? ISO_GLOSSARY_UK : ISO_GLOSSARY_EN;

    case "raja-vidya":
      return RAJA_VIDYA_GLOSSARY_UK;
