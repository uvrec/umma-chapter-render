...
// Централізований хук для налаштувань читалки, що синхронізується через localStorage + події
...
export function useReaderSettings() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener("vv-reader-prefs-changed", onUpdate);
  }, []);
