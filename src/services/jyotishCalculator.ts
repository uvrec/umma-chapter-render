...
const TITHIS: Omit<Tithi, 'paksha' | 'paksha_number'>[] = [
  { number: 1, name_iast: 'Pratipadā', name_uk: 'Пратіпада', name_en: 'Pratipada', deity_uk: 'Аґні', deity_en: 'Agni', nature: 'nanda', is_ekadashi: false },
  { number: 2, name_iast: 'Dvitīyā', name_uk: 'Двітія', name_en: 'Dwitiya', deity_uk: 'Брахма', deity_en: 'Brahma', nature: 'bhadra', is_ekadashi: false },
  { number: 3, name_iast: 'Tṛtīyā', name_uk: 'Трітія', name_en: 'Tritiya', deity_uk: 'Ґаурі', deity_en: 'Gauri', nature: 'jaya', is_ekadashi: false },
  { number: 4, name_iast: 'Caturthī', name_uk: 'Чатуртхі', name_en: 'Chaturthi', deity_uk: 'Ґанеша', deity_en: 'Ganesha', nature: 'rikta', is_ekadashi: false },
  { number: 5, name_iast: 'Pañcamī', name_uk: 'Панчамі', name_en: 'Panchami', deity_uk: 'Наґи', deity_en: 'Nagas', nature: 'purna', is_ekadashi: false },
  { number: 6, name_iast: 'Ṣaṣṭhī', name_uk: 'Шаштхі', name_en: 'Shashthi', deity_uk: 'Карттікея', deity_en: 'Kartikeya', nature: 'nanda', is_ekadashi: false },
  { number: 7, name_iast: 'Saptamī', name_uk: 'Саптамі', name_en: 'Saptami', deity_uk: 'Сур\'я', deity_en: 'Surya', nature: 'bhadra', is_ekadashi: false },
  { number: 8, name_iast: 'Aṣṭamī', name_uk: 'Аштамі', name_en: 'Ashtami', deity_uk: 'Рудра', deity_en: 'Rudra', nature: 'jaya', is_ekadashi: false },
  { number: 9, name_iast: 'Navamī', name_uk: 'Навамі', name_en: 'Navami', deity_uk: 'Дурґа', deity_en: 'Durga', nature: 'rikta', is_ekadashi: false },
  { number: 10, name_iast: 'Daśamī', name_uk: 'Дашамі', name_en: 'Dashami', deity_uk: 'Дгарма', deity_en: 'Dharma', nature: 'purna', is_ekadashi: false },
  { number: 11, name_iast: 'Ekādaśī', name_uk: 'Екадаші', name_en: 'Ekadashi', deity_uk: 'Вішну', deity_en: 'Vishnu', nature: 'nanda', is_ekadashi: true },
  { number: 12, name_iast: 'Dvādaśī', name_uk: 'Двадаші', name_en: 'Dwadashi', deity_uk: 'Вішну', deity_en: 'Vishnu', nature: 'bhadra', is_ekadashi: false },
  { number: 13, name_iast: 'Trayodaśī', name_uk: 'Трайодаші', name_en: 'Trayodashi', deity_uk: 'Кама', deity_en: 'Kama', nature: 'jaya', is_ekadashi: false },
  { number: 14, name_iast: 'Caturdaśī', name_uk: 'Чатурдаші', name_en: 'Chaturdashi', deity_uk: 'Шіва', deity_en: 'Shiva', nature: 'rikta', is_ekadashi: false },
  { number: 15, name_iast: 'Pūrṇimā/Amāvasyā', name_uk: 'Пурніма/Амавас\'я', name_en: 'Purnima/Amavasya', deity_uk: 'Чандра/Пітри', deity_en: 'Chandra/Pitris', nature: 'purna', is_ekadashi: false },
];
 ...
 */
const YOGAS: Yoga[] = [
  { id: 1, name_iast: 'Viṣkambha', name_uk: 'Вішкамбга', name_en: 'Vishkambha', nature: 'inauspicious', deity_uk: 'Яма', deity_en: 'Yama', description_uk: 'Перешкода', description_en: 'Obstacle' },
  { id: 2, name_iast: 'Prīti', name_uk: 'Пріті', name_en: 'Priti', nature: 'auspicious', deity_uk: 'Вішну', deity_en: 'Vishnu', description_uk: 'Любов', description_en: 'Love' },
  { id: 3, name_iast: 'Āyuṣmān', name_uk: 'Аюшман', name_en: 'Ayushman', nature: 'auspicious', deity_uk: 'Чандра', deity_en: 'Chandra', description_uk: 'Довголіття', description_en: 'Longevity' },
  { id: 4, name_iast: 'Saubhāgya', name_uk: 'Саубгаґья', name_en: 'Saubhagya', nature: 'auspicious', deity_uk: 'Брахма', deity_en: 'Brahma', description_uk: 'Удача', description_en: 'Fortune' },
  { id: 5, name_iast: 'Śobhana', name_uk: 'Шобгана', name_en: 'Shobhana', nature: 'auspicious', deity_uk: 'Бріхаспаті', deity_en: 'Brihaspati', description_uk: 'Краса', description_en: 'Beauty' },
  { id: 6, name_iast: 'Atigaṇḍa', name_uk: 'Атіґанда', name_en: 'Atiganda', nature: 'inauspicious', deity_uk: 'Чандра', deity_en: 'Chandra', description_uk: 'Небезпека', description_en: 'Danger' },
  { id: 7, name_iast: 'Sukarma', name_uk: 'Сукарма', name_en: 'Sukarma', nature: 'auspicious', deity_uk: 'Індра', deity_en: 'Indra', description_uk: 'Добра дія', description_en: 'Good deed' },
  { id: 8, name_iast: 'Dhṛti', name_uk: 'Дхріті', name_en: 'Dhriti', nature: 'auspicious', deity_uk: 'Вода', deity_en: 'Water', description_uk: 'Стійкість', description_en: 'Steadiness' },
  { id: 9, name_iast: 'Śūla', name_uk: 'Шула', name_en: 'Shula', nature: 'inauspicious', deity_uk: 'Змія', deity_en: 'Serpent', description_uk: 'Біль', description_en: 'Pain' },
  { id: 10, name_iast: 'Gaṇḍa', name_uk: 'Ґанда', name_en: 'Ganda', nature: 'inauspicious', deity_uk: 'Аґні', deity_en: 'Agni', description_uk: 'Вузол', description_en: 'Knot' },
  { id: 11, name_iast: 'Vṛddhi', name_uk: 'Вріддгі', name_en: 'Vriddhi', nature: 'auspicious', deity_uk: 'Сур\'я', deity_en: 'Surya', description_uk: 'Зростання', description_en: 'Growth' },
  { id: 12, name_iast: 'Dhruva', name_uk: 'Дгрува', name_en: 'Dhruva', nature: 'auspicious', deity_uk: 'Бгумі', deity_en: 'Bhumi', description_uk: 'Сталість', description_en: 'Permanence' },
  { id: 13, name_iast: 'Vyāghāta', name_uk: 'В\'яґгата', name_en: 'Vyaghata', nature: 'inauspicious', deity_uk: 'Ваю', deity_en: 'Vayu', description_uk: 'Руйнування', description_en: 'Destruction' },
  { id: 14, name_iast: 'Harṣaṇa', name_uk: 'Харшана', name_en: 'Harshana', nature: 'auspicious', deity_uk: 'Бгаґа', deity_en: 'Bhaga', description_uk: 'Радість', description_en: 'Joy' },
  { id: 15, name_iast: 'Vajra', name_uk: 'Ваджра', name_en: 'Vajra', nature: 'neutral', deity_uk: 'Варуна', deity_en: 'Varuna', description_uk: 'Блискавка', description_en: 'Lightning' },
  { id: 16, name_iast: 'Siddhi', name_uk: 'Сіддгі', name_en: 'Siddhi', nature: 'auspicious', deity_uk: 'Ґанеша', deity_en: 'Ganesha', description_uk: 'Досягнення', description_en: 'Achievement' },
  { id: 17, name_iast: 'Vyatīpāta', name_uk: 'В\'ятіпата', name_en: 'Vyatipata', nature: 'inauspicious', deity_uk: 'Рудра', deity_en: 'Rudra', description_uk: 'Катастрофа', description_en: 'Calamity' },
  { id: 18, name_iast: 'Varīyān', name_uk: 'Варіян', name_en: 'Variyan', nature: 'auspicious', deity_uk: 'Лакшмі', deity_en: 'Lakshmi', description_uk: 'Найкращий', description_en: 'Best' },
  { id: 19, name_iast: 'Parigha', name_uk: 'Паріґха', name_en: 'Parigha', nature: 'inauspicious', deity_uk: 'Вішвакарма', deity_en: 'Vishwakarma', description_uk: 'Бар\'єр', description_en: 'Barrier' },
  { id: 20, name_iast: 'Śiva', name_uk: 'Шіва', name_en: 'Shiva', nature: 'auspicious', deity_uk: 'Шіва', deity_en: 'Shiva', description_uk: 'Благо', description_en: 'Auspicious' },
  { id: 21, name_iast: 'Siddha', name_uk: 'Сіддга', name_en: 'Siddha', nature: 'auspicious', deity_uk: 'Ґанеша', deity_en: 'Ganesha', description_uk: 'Досконалий', description_en: 'Perfect' },
  { id: 22, name_iast: 'Sādhya', name_uk: 'Садх\'я', name_en: 'Sadhya', nature: 'auspicious', deity_uk: 'Савітар', deity_en: 'Savitar', description_uk: 'Досяжний', description_en: 'Achievable' },
  { id: 23, name_iast: 'Śubha', name_uk: 'Шубга', name_en: 'Shubha', nature: 'auspicious', deity_uk: 'Лакшмі', deity_en: 'Lakshmi', description_uk: 'Благий', description_en: 'Good' },
  { id: 24, name_iast: 'Śukla', name_uk: 'Шукла', name_en: 'Shukla', nature: 'auspicious', deity_uk: 'Парваті', deity_en: 'Parvati', description_uk: 'Світлий', description_en: 'Bright' },
  { id: 25, name_iast: 'Brahma', name_uk: 'Брахма', name_en: 'Brahma', nature: 'auspicious', deity_uk: 'Брахма', deity_en: 'Brahma', description_uk: 'Творець', description_en: 'Creator' },
  { id: 26, name_iast: 'Indra', name_uk: 'Індра', name_en: 'Indra', nature: 'auspicious', deity_uk: 'Індра', deity_en: 'Indra', description_uk: 'Цар', description_en: 'King' },
  { id: 27, name_iast: 'Vaidhṛti', name_uk: 'Вайдхріті', name_en: 'Vaidhriti', nature: 'inauspicious', deity_uk: 'Дгатрі', deity_en: 'Dhatri', description_uk: 'Дисонанс', description_en: 'Dissonance' },
];
...
const KARANAS: Karana[] = [
  { id: 1, name_iast: 'Bava', name_uk: 'Бава', name_en: 'Bava', type: 'chara', nature: 'auspicious', deity_uk: 'Індра', deity_en: 'Indra' },
  { id: 2, name_iast: 'Bālava', name_uk: 'Балава', name_en: 'Balava', type: 'chara', nature: 'auspicious', deity_uk: 'Брахма', deity_en: 'Brahma' },
  { id: 3, name_iast: 'Kaulava', name_uk: 'Каулава', name_en: 'Kaulava', type: 'chara', nature: 'auspicious', deity_uk: 'Мітра', deity_en: 'Mitra' },
  { id: 4, name_iast: 'Taitila', name_uk: 'Тайтіла', name_en: 'Taitila', type: 'chara', nature: 'auspicious', deity_uk: 'Ар\'яман', deity_en: 'Aryaman' },
  { id: 5, name_iast: 'Gara', name_uk: 'Ґара', name_en: 'Gara', type: 'chara', nature: 'neutral', deity_uk: 'Бгумі', deity_en: 'Bhumi' },
  { id: 6, name_iast: 'Vaṇija', name_uk: 'Ваніджа', name_en: 'Vanija', type: 'chara', nature: 'auspicious', deity_uk: 'Лакшмі', deity_en: 'Lakshmi' },
  { id: 7, name_iast: 'Viṣṭi', name_uk: 'Вішті', name_en: 'Vishti', type: 'chara', nature: 'inauspicious', deity_uk: 'Яма', deity_en: 'Yama' },
  // Стхіра карани (фіксовані)
  { id: 8, name_iast: 'Śakuni', name_uk: 'Шакуні', name_en: 'Shakuni', type: 'sthira', nature: 'inauspicious', deity_uk: 'Каліка', deity_en: 'Kalika' },
  { id: 9, name_iast: 'Catuṣpāda', name_uk: 'Чатушпада', name_en: 'Chatushpada', type: 'sthira', nature: 'neutral', deity_uk: 'Рудра', deity_en: 'Rudra' },
  { id: 10, name_iast: 'Nāga', name_uk: 'Наґа', name_en: 'Naga', type: 'sthira', nature: 'neutral', deity_uk: 'Наґи', deity_en: 'Nagas' },
  { id: 11, name_iast: 'Kiṃstughna', name_uk: 'Кімстуґхна', name_en: 'Kimstughna', type: 'sthira', nature: 'auspicious', deity_uk: 'Манмадха', deity_en: 'Manmadha' },
];
 ...
 */
const VARAS: Vara[] = [
  { id: 0, name_iast: 'Ravivāra', name_uk: 'Равівара (Неділя)', name_en: 'Sunday', ruler: 'surya', nature: 'neutral' },
  { id: 1, name_iast: 'Somavāra', name_uk: 'Сомавара (Понеділок)', name_en: 'Monday', ruler: 'chandra', nature: 'auspicious' },
  { id: 2, name_iast: 'Maṅgalavāra', name_uk: 'Манґалавара (Вівторок)', name_en: 'Tuesday', ruler: 'mangala', nature: 'inauspicious' },
  { id: 3, name_iast: 'Budhavāra', name_uk: 'Будгавара (Середа)', name_en: 'Wednesday', ruler: 'budha', nature: 'auspicious' },
  { id: 4, name_iast: 'Guruvāra', name_uk: 'Ґурувара (Четвер)', name_en: 'Thursday', ruler: 'guru', nature: 'auspicious' },
  { id: 5, name_iast: 'Śukravāra', name_uk: 'Шукравара (П\'ятниця)', name_en: 'Friday', ruler: 'shukra', nature: 'auspicious' },
  { id: 6, name_iast: 'Śanivāra', name_uk: 'Шанівара (Субота)', name_en: 'Saturday', ruler: 'shani', nature: 'inauspicious' },
];
...
export async function getJyotishReading(birthData: BirthData): Promise<JyotishReading> {
  ...
  return {
    ...
    personality_uk: interpretation.personality_uk,
    personality_en: interpretation.personality_en,
    strengths_uk: interpretation.strengths_uk,
    strengths_en: interpretation.strengths_en,
    challenges_uk: interpretation.challenges_uk,
    challenges_en: interpretation.challenges_en,
    career_uk: interpretation.career_uk,
    career_en: interpretation.career_en,
    compatibility_uk: interpretation.compatibility_uk,
...
function generateInterpretation(
  ...
  const personality_uk = `Ваша накшатра народження — ${nakshatra.name_uk} (${nakshatra.name_sanskrit}), що перебуває під впливом ${nakshatraRuler?.name_uk || nakshatra.ruler_planet}. ${nakshatra.description_uk} Місяць у ${moonRashi.name_uk} (${moonRashi.western_name_uk}) надає вашим емоціям ${moonRashi.description_uk.toLowerCase()}`;
  ...
  return {
    personality_uk,
    personality_en,
    strengths_uk: [...nakshatra.positive_traits_uk, ...moonRashi.positive_traits_uk.slice(0, 3)],
    strengths_en: [...nakshatra.positive_traits_en, ...moonRashi.positive_traits_en.slice(0, 3)],
    challenges_uk: [...nakshatra.negative_traits_uk, ...moonRashi.negative_traits_uk.slice(0, 2)],
    challenges_en: [...nakshatra.negative_traits_en, ...moonRashi.negative_traits_en.slice(0, 2)],
    career_uk: nakshatra.career_uk,
    career_en: nakshatra.career_en,
    compatibility_uk: `Найкраща сумісність з накшатрами, якими володіє ${nakshatraRuler?.name_uk || 'та сама планета'}.`,
...
export async function getVedicPortrait(birthData: BirthData): Promise<VedicPortrait> {
  ...
  const combined_interpretation_uk = generateCombinedInterpretation(jyotish, numerology, 'uk');
...
function generateCombinedInterpretation(
  ...
  if (lang === 'uk') {
    return `Ваш ведичний портрет: накшатра ${nakshatra.name_uk} у ${rashi.name_uk} (${rashi.western_name_uk}) поєднується з нумерологічним числом підсумку ${numerology.lifeNumber}. Формула ${numerology.notation} вказує на ${getLifeNumberTheme(numerology.lifeNumber, 'uk')}. ${nakshatra.description_uk}`;
  }
